                ...
                return (
                  ...
                  >
                    <div className='flex gap-4'>
                      ...
                      {/* Product Image */}
                      <div 
                        className='w-24 h-24 flex-shrink-0 bg-slate-800 rounded-lg overflow-hidden cursor-pointer'
                      ...
                      <div className='flex-1 min-w-0'>
                        <h3 
                          className='text-white font-semibold text-lg mb-2 truncate cursor-pointer hover:text-violet-400 transition-colors'
                          onClick={() => navigate(`/productdetail/${productData._id}`)}
                        >
                          {productData.name}
                        </h3>
                        ...
                        <div className='flex items-center gap-4 mb-3'>
                          ...
                          <div className='px-3 py-1 bg-slate-800 border border-slate-700 rounded text-slate-300 text-sm'>
                            Size: {item.size}
                          </div>
                        </div>
                        ...
                        <div className='flex items-center gap-3'>
                          <div className='flex items-center gap-2 bg-slate-800 border border-slate-700 rounded-lg'>
                            <button
                              onClick={() => UpdateQuantity(item._id, item.size, item.quantity - 1)}
                              className='w-8 h-8 flex items-center justify-center text-slate-400 hover:text-white hover:bg-slate-700 transition-colors rounded-l-lg'
                      ...
                      <button
                        ...
                        className='flex-shrink-0 w-10 h-10 flex items-center justify-center text-slate-400 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors'
                      >
            ...
            <div className='lg:col-span-1'>
              <div className='bg-slate-900 border border-slate-800 rounded-lg p-6 sticky top-24'>
                ...
                <button
                  ...
                  className='w-full mt-6 px-6 py-3 bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-white font-semibold rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-violet-500/30'
                >
                  Proceed to Checkout
                </button>
