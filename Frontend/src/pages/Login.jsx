    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-pink-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#ff3f6c] to-rose-400 flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <h1 className="text-4xl font-extrabold mb-3">OneCart</h1>
          <p className="text-rose-100 text-lg mb-8">India's Smarter Way to Shop</p>
          <div className="space-y-4 text-left">
            {[
              "🛍️ 50,000+ premium products",
              "🚚 Free delivery on ₹499+",
              "🔄 14-day easy returns",
              "⭐ 4.8 star rated platform",
            ].map((item) => (
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex justify-end">
              <button type="button" className="text-sm text-[#ff3f6c] font-semibold hover:underline">
                Forgot password?
              </button>
            </div>
            ...
            <button
              ...
              className="w-full h-12 bg-[#ff3f6c] hover:bg-[#e8365d] text-white font-bold rounded-xl transition-colors flex items-center justify-center gap-2 shadow-lg shadow-[#ff3f6c]/25 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {loading ? (
          ...
          <p className="text-center text-gray-600 text-sm mt-6">
            ...
            <button onClick={() => navigate("/signup")} className="text-[#ff3f6c] font-bold hover:underline">
              Create Account
            </button>
          </p>
          ...
          <div className="flex items-center justify-center gap-2 text-xs text-gray-400 mt-8">
            ...
            By continuing, you agree to OneCart's Terms & Privacy Policy
          </div>
        </div>
      </div>
    </div>
